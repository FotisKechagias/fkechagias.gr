...
(function () {
  ...
  /* Accent οικογένεια (ίδια απόχρωση, διαφορετική ένταση) */
  var palette = [
    [0.49, 0.56, 0.96],  /* #7d8ff4 accent      */
    [0.58, 0.64, 1.00],  /* φωτεινότερο accent   */
    [0.38, 0.44, 0.74],  /* βαθύτερο accent      */
    [0.84, 0.86, 0.94]   /* ψυχρό σχεδόν-λευκό   */
  ];
